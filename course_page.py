...
class CoursesPage(QWidget):
    ...
    def initUI(self):
        ...
        # Область подробной информации о курсе
        ...
        # Область и кнопки для редактирования, удаления и добавления курсов
        ...
        # Устанавливаем макет courses_layout для courses_area
